...
names(df_tb30_n)[6] <- "MenUnemploymentRate2020"
names(df_tb30_n)[7] <- "MenUnemploymentRate2021"
names(df_tb30_n)[8] <- "WomenUnemploymentRate2020"
names(df_tb30_n)[9] <- "WomenUnemploymentRate2021"
...
```{r}
df_tb30_n1$TotalUnemployedRatesApril2020<-as.numeric(df_tb30_n1$TotalUnemployedRatesApril2020)
df_tb30_n1$TotalUnemployedRatesApril2021<-as.numeric(df_tb30_n1$TotalUnemployedRatesApril2021)
str(df_tb30_n)
```
