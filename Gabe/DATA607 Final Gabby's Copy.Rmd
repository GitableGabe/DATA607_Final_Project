...
- [ ] Your project has a recognizable “data science workflow,” such as the <span style="color:blue">OSEMN workflow</span>  or Hadley Wickham’s Grammar of Data Science. [Example: First the data is acquired, then necessary transformations and clean-up are performed, then the analysis and presentation work is performed] 
