...
=======
>>>>>>> c67b6143dc7c2bcc647124e74ff128a4c333a16a
### Load Data

In order to conduct our studies we used the [data tables](https://www.bls.gov/cps/tables.htm#empstat) from U.S. Bureau of Labor Statistics.
...
colnames(test) <- c("Age_Group", "03/2020", "04/2020", "05/2020","06/2020","07/2020","08/2020","09/2020","10/2020","11/2020","12/2020","01/2021","02/2021","03/2021")

men9<-test[16:27,]
men9$Gender <- ("Male")
#men9 <- men9 
#%>% gather("Month_Year", "Population", 2:14)

women9 <- test[29:40,]
women9$Gender <- ("Female")
# women9 <- women9 %>%
#   gather("Month_Year", "Population", 2:14) 

m_w_9 <- rbind(men9, women9)
