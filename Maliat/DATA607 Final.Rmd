...
df_tb10marital$`Marital Label`<- c("Male - Married with Spouse Present",
                                   "Female - Married with Spouse Present")
...
ggplot(df_tb10maritalm, aes(x=factor(Month_Year), 
                            y = (Rate),color = `Marital Label`,
